  ...
  const ScheduleTab = () => {
    ...
    return (
      <div className="pb-4 relative">
        ...
        <div className="mt-3 mb-4 rounded-md border border-dashed border-zinc-300 px-4 py-2 text-sm space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-zinc-500">Activities (base prices)</span>
