                  ...
                  >
                    ...
                    {!isSingleSelect && (
                      <button
                        ...
                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-background rounded-full p-2 shadow-lg hover:bg-zinc-100 pointer-events-auto"
                      >
