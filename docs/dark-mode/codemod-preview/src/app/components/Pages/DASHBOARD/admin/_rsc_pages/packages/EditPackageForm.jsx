...
export const EditPackageForm = ({ categories, attributes, tags, locations = [], allactivities, alltransfers, itineraries, packageData }) => {
    ...
    () => () => {
      ...
      return (
        <div className="flex flex-col gap-4 py-4 relative">
          <Button type="button" className="bg-background hover:bg-white border text-inherit self-end" onClick={() => addInformationField({ section_title: '', content: '' })}>
            Add Section
          </Button>
  ...
  const FaqTab = () => {
    ...
    return (
      <div className="flex flex-col gap-4 py-4 relative">
        <Button type="button" className="bg-background hover:bg-white border text-inherit self-end" onClick={handleAddFaqfield}>
          Add Section
        </Button>
