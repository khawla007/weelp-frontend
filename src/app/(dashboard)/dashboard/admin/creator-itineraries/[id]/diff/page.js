...
export default async function DiffPage({ params }) {
  ...
  if (!result.success) {
    return (
      <div className="p-6">
        <h1 className="text-2xl font-semibold text-[#18181b] mb-4" style={{ fontFamily: 'var(--font-plus-jakarta), "Plus Jakarta Sans", sans-serif' }}>
          Review Edit Changes
        </h1>
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-[#18181b]" style={{ fontFamily: 'var(--font-plus-jakarta), "Plus Jakarta Sans", sans-serif' }}>
          Review Edit Changes
        </h1>
