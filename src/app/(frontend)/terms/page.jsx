    ...
    <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
      ...
      <div className="space-y-10">
        ...
        <section className="space-y-4">
          ...
          <Paragraph>
            To access certain features of the Platform, you must register for an account. You agree to provide accurate, current, and complete information during registration and to keep your account
            information up to date. You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You must be at least 18
            years of age to create an account and use the Platform.
          </Paragraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <Paragraph>
            Weelp operates as a marketplace platform and is not the direct provider of any travel services, activities, or accommodations. Weelp is not liable for the actions, omissions, or negligence
            of creators or vendors. To the maximum extent permitted by applicable law, Weelp&apos;s total liability to you in connection with any claim arising from your use of the Platform shall not
            exceed the amount you paid for the specific booking giving rise to that claim.
          </Paragraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <Paragraph>
            Weelp reserves the right to modify these Terms of Service at any time. We will notify you of changes by updating this page with a revised &quot;Last updated&quot; date. Your continued use
            of the Platform following the posting of any changes constitutes your acceptance of the revised Terms.
          </Paragraph>
        </section>
