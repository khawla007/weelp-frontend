...
const BookYourTaxi = () => {
  return (
    <>
      <section className="relative min-h-[320px] sm:min-h-[420px] h-full flex justify-center items-center bg-surface-tint p-6">
        <div className="max-w-xl w-full flex flex-col justify-center items-center gap-2">
          <h1 className="text-xl sm:text-5xl font-semibold text-foreground text-center">Book Your Taxi</h1>
          <p className="text-sm sm:text-lg font-medium text-weelp-steel text-center">
