    ...
    <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
      ...
      <div className="space-y-10">
        ...
        <section className="space-y-4">
          ...
          <Paragraph>
            Weelp operates a travel booking platform that connects travellers with experiences, activities, and holiday packages around the world. We are committed to protecting your privacy and
            handling your personal information with transparency and care.
          </Paragraph>
          <Paragraph>
            By accessing or using our platform, you agree to the collection and use of information in accordance with this Privacy Policy. If you do not agree with any part of this policy, please do
        ...
        <section className="space-y-4">
          ...
          <Paragraph>We collect the following categories of information when you use Weelp:</Paragraph>
          <BulletList
            items={[
        ...
        <section className="space-y-4">
          ...
          <Paragraph>
            We do <strong>not</strong> sell, rent, or trade your personal data to third parties. We may share your information only in the following circumstances:
          </Paragraph>
          <BulletList
            items={[
        ...
        <section className="space-y-4">
          ...
          <Paragraph>We implement industry-standard security measures to protect your personal information, including:</Paragraph>
          <BulletList
            items={[
          ...
          />
          <Paragraph>
            While we are committed to protecting your data, no method of transmission over the internet or electronic storage is 100% secure. In the event of a data breach, we will act promptly to
            assess and address the impact in accordance with applicable laws.
          </Paragraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <Paragraph>We use cookies and similar tracking technologies on our platform. These fall into three categories:</Paragraph>
          <BulletList
            items={[
          ...
          />
          <Paragraph>
            You can manage your cookie preferences through your browser settings. Please note that disabling essential cookies may affect the functionality of certain features on the platform.
          </Paragraph>
        </section>
        ...
        <section className="space-y-4">
          ...
          <Paragraph>
            We may update this Privacy Policy from time to time to reflect changes in our practices, technology, or legal requirements. When we do, we will notify you by updating the policy on this
            page and revising the &quot;Last updated&quot; date at the top. Your continued use of Weelp following any changes constitutes your acceptance of the updated policy.
          </Paragraph>
          <Paragraph>We encourage you to review this page periodically to stay informed about how we are protecting your information.</Paragraph>
        </section>
