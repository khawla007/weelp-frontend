...
jest.mock('../../../../lib/services/notifications', () => ({
  fetchPopupNotifications: jest
    .fn()
    .mockResolvedValue([{ id: 99, type: 'custom', display_style: 'popup', title: 'Coupon', message: 'Body', created_at: new Date().toISOString(), action_url: '/x', data: { images: [] } }]),
