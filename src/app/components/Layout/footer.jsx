        ...
        <div className="w-full px-4 pt-10 sm:pt-14 md:pt-[71px] lg:px-[60px]">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative z-10 mt-6 flex flex-wrap justify-end gap-5 pb-4 sm:gap-6">
              <a href="#" aria-label="Instagram" className="text-[#71717a] hover:text-[#18181b] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#588f7a]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-white rounded-sm transition">
              ...
              <a href="#" aria-label="X / Twitter" className="text-[#71717a] hover:text-[#18181b] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#588f7a]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-white rounded-sm transition">
                <svg width="22" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" aria-label="TikTok" className="text-[#71717a] hover:text-[#18181b] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#588f7a]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-white rounded-sm transition">
