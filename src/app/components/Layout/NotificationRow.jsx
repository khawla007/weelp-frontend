  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {isPopup && (
          <button type="button" onClick={handleVisit} className="mt-2 inline-flex items-center text-xs font-medium text-weelp-copy hover:text-weelp-sage-text hover:underline">
            View detail
          </button>
        )}
        {cta &&
          (cta.external ? (
            ...
            <NavigationLink href={cta.href} onClick={handleVisit} className="mt-2 inline-block text-xs font-medium text-weelp-copy hover:text-weelp-sage-text hover:underline">
              Visit
            </NavigationLink>
          ))}
      </div>
