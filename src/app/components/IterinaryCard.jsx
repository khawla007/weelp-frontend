...
const ItineraryCard = ({ productId, imgsrc, productTitle, category }) => {
  return (
    <div className={`${'product_' + productId} bg-background rounded-lg gap-3 shadow-md sm:max-w-fit max-w-full min-h-fit h-fit w-full sm:mx-0`}>
      <Link href={'/blogs/blog'}>
        ...
        <div className="flex justify-between p-4">
          <div className="flex flex-col gap-[6px] justify-evenly py-1">
            <p className="text-weelp-steel text-lg font-medium">{category ? category : 'Itinerary'}</p>
