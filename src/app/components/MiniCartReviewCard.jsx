...
const MiniCartReviewCard = ({ imageSrc, productTitle, href }) => {
  ...
  const card = (
    <div
      data-public-card="mini-cart-recommendation"
      className={`flex gap-4 items-center bg-background p-3 max-w-xs w-full border border-border hover:shadow-sm transition-shadow ${PUBLIC_CARD_RADIUS_CLASS}`}
    >
