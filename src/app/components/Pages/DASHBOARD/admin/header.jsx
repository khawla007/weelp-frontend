...
const AdminHeader = () => {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      case 'order': return <FileText size={16} className="text-blue-500" />;
      case 'user': return <User size={16} className="text-green-500" />;
      case 'activity': return <Activity size={16} className="text-orange-500" />;
      case 'package': return <Package size={16} className="text-purple-500" />;
      case 'blog': return <FileText size={16} className="text-pink-500" />;
  ...
  const getTypeBadgeColor = (type) => {
    switch (type) {
      case 'order': return 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300';
      case 'user': return 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300';
      case 'activity': return 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300';
      case 'package': return 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300';
      case 'blog': return 'bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300';
