        ...
        {!isEmpty(selectedItinerary) && (
          <div className="modal">
            <div className="modal-content">
              ...
              <div className="flex flex-col gap-4 mt-4">
                <Button onClick={handleAddItinerary} className="p-2 rounded-md w-full bg-weelp-sage-deep text-white hover:bg-weelp-sage-deep/90 hover:text-white">
                  Done
                </Button>
              </div>
            </div>
      ...
      <DialogContent>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <div className="flex flex-col gap-4 mt-4">
              <Button onClick={handleUpdateItinerary} className="p-2 rounded-md w-full bg-weelp-sage-deep text-white hover:bg-weelp-sage-deep/90 hover:text-white">
                Submit
              </Button>
            </div>
          </div>
