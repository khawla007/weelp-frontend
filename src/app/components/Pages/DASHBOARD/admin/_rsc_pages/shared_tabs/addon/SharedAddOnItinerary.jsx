...
import { useItineraryAddOnsAdmin } from '@/hooks/api/admin/addon';

/**
 * Itinerary-specific AddOn MultiSelect component
 * Shows only type='itinerary' addons
 */
const SmartAddOnMultiSelectItinerary = () => {
  const {
    control,
    formState: { errors },
  } = useFormContext();

  const { data, error, isLoading } = useItineraryAddOnsAdmin();
...
export default SmartAddOnMultiSelectItinerary;
