...
import { useTransferAddOnsAdmin } from '@/hooks/api/admin/addon';

/**
 * Transfer-specific AddOn MultiSelect component
 * Shows only type='transfer' addons
 */
const SmartAddOnMultiSelectTransfer = () => {
  const {
    control,
    formState: { errors },
  } = useFormContext();

  const { data, error, isLoading } = useTransferAddOnsAdmin();
...
export default SmartAddOnMultiSelectTransfer;
