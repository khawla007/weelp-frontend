...
import { useActivityAddOnsAdmin } from '@/hooks/api/admin/addon';

/**
 * Activity-specific AddOn MultiSelect component
 * Shows only type='activity' addons
 */
const SmartAddOnMultiSelectActivity = () => {
  const {
    control,
    formState: { errors },
  } = useFormContext();

  const { data, error, isLoading } = useActivityAddOnsAdmin();
...
export default SmartAddOnMultiSelectActivity;
