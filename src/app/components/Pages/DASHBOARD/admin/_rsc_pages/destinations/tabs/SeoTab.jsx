      ...
      <AccordionItem value="item-1">
        ...
        <AccordionContent className="px-2 space-y-4">
          <div className="space-y-2">
            ...
            <Input type="text" maxLength="60" placeholder="Enter meta title" className="focus-visible:ring-[#588f7a]" {...register('seo.meta_title')} />
          ...
          <div className="space-y-2">
            ...
            <Input type="text" placeholder="Enter meta description" maxLength="160" className="focus-visible:ring-[#588f7a]" {...register('seo.meta_description')} />
          ...
          <div className="space-y-2">
            ...
            <Input type="url" placeholder="Enter OG Image Url" className="focus-visible:ring-[#588f7a]" {...register('seo.og_image_url')} />
          ...
          <div className="space-y-2">
            ...
            <Input type="url" placeholder="Enter canonical URL" className="focus-visible:ring-[#588f7a]" {...register('seo.canonical_url')} />
