          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>Create a new schedule for availability</DialogDescription>
              </DialogHeader>

              {/* Create Vendor Form*/}
              <CreateVendorScheduleForm onSuccess={() => setOpen(false)} />
            </DialogContent>
          </Dialog>
        )}
      </Card>
...
export default CreateVendorScheduleDialog;
