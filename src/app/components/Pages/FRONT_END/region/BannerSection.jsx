...
const BannerSection = () => {
  ...
  return (
    <section className="relative flex min-h-[420px] sm:min-h-[480px] md:min-h-[520px] lg:min-h-[60vh] page_country_banner" style={{ background: 'linear-gradient(to bottom, #FFFFFF, #f2f7f5)' }}>
