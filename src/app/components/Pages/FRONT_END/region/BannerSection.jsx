...
const BannerSection = () => {
  ...
  return (
    <section className="relative flex min-h-[420px] sm:min-h-[480px] md:min-h-[520px] lg:min-h-[60vh] page_country_banner" style={{ background: 'linear-gradient(to bottom, #FFFFFF, #EAF1EE)' }}>
      <div className="relative mx-auto flex h-full w-full items-center">
        ...
        <div className="relative hidden h-full w-full flex-[1] items-end justify-start bg-cover bg-no-repeat lg:flex" style={{ backgroundImage: `url(${bannerImage})` }}>
          <div className="absolute left-[20%] top-[70%]">
            <p className="w-3/5 text-lg text-[#DFDFEB]">This far flung region is made of icy blue waters and snow covered landscapes of incredible beauty.</p>
          </div>
        </div>
      </div>
    </section>
