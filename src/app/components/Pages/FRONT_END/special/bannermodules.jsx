...
export const BannerSelectBox = () => {
  return (
    <div className="flex justify-center gap-4 mt-8">
      <Select>
        <SelectTrigger className="w-[180px] px-6 py-6 focus:ring-0 focus:ring-offset-0 border-none text-white opacity-80 font-light bg-[#18181b]">
          <SelectValue className="" placeholder="Kashmir" />
        </SelectTrigger>
        <SelectContent className={'bg-[#18181b] text-white mt-2 border-none outline-none'}>
          <SelectGroup>
      ...
      <Select>
        ...
        <SelectContent className={'bg-[#18181b] text-white mt-2 border-none'}>
          <SelectGroup>
