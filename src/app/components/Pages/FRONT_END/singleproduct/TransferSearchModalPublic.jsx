          ...
          <>
            <div className="flex gap-2 items-center">
              <div className="relative flex-1">
                ...
                <Input type="text" placeholder="Search transfers..." value={search} onChange={(e) => setSearch(e.target.value)} className="pl-9 focus-visible:ring-weelp-sage-deep focus-visible:ring-1" />
              </div>
            </div>
        ...
        {stage === 'configure' && selectedTransfer && (
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button onClick={handleConfirm} disabled={!isConfigValid} className="flex-1 bg-weelp-sage-deep hover:bg-weelp-sage-deep/90">
                Confirm Transfer
              </Button>
            </div>
          </div>
