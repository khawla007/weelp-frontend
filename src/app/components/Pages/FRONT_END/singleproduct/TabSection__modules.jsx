...
export const ProductForm = ({ productId, productData }) => {
  ...
  return (
    <div className="p-6 lg:px-[60px] lg:pt-[60px] lg:pb-[70px] lg:sticky lg:top-[76px]">
      ...
      <SingleProductForm productId={productId} productData={productData} selectedAddons={selectedAddons} formId={`booking-form-${productId}`} />
      ...
      {/* Select Card — total price left, button right */}
