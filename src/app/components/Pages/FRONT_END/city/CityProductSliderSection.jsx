...
export default function CityProductSliderSection({ title, subtitle, items = [], navigationId }) {
    ...
    <section className="mx-auto flex w-full max-w-[1480px] flex-col gap-7 px-4 sm:px-6 xl:px-0 py-12">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className={`${navPrefix}-prev rounded-full bg-[#F4F4F5] px-3 py-[10px] text-[#18181B] transition hover:bg-[#E4E4E7]`}
          ...
          <button
            type="button"
            className={`${navPrefix}-next rounded-full bg-[#18181B] px-3 py-[10px] text-white transition hover:bg-[#27272A]`}
