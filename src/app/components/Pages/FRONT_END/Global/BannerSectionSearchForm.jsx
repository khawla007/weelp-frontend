...
const BannerSectionSearchForm = ({ title, description }) => {
  ...
  if (title && description) {
    return (
      <section className="relative overflow-hidden min-h-[320px] sm:min-h-[420px] h-full flex justify-center items-center bg-[#F5F9FA] p-6">
        <div className="max-w-xl w-full flex flex-col justify-center items-center gap-2">
          ...
          <img alt="logo" className="hidden 2xl:block absolute -top-8 right-0 scale-90 pointer-events-none" src="/assets/Group5.png" />
        </div>
      </section>
    );
  }
