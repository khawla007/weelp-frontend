    ...
    >
      <div className="container-page relative z-0 flex flex-col items-center justify-center text-center">
        ...
        <div className="relative flex flex-col items-center">
          <div
            aria-hidden="true"
            className="hero-rise pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[222px] w-[538px] max-w-[90vw] -translate-x-1/2 -translate-y-1/2 rounded-[150px] blur-[30px]"
            style={{
              background:
          ...
          <p className="hero-rise mb-8 max-w-[44ch] text-base sm:text-lg font-medium leading-[1.4] text-[#52525b]" style={{ '--hero-rise-delay': '160ms' }}>
        ...
        <div className="hero-rise mt-4 flex flex-wrap items-center justify-center gap-3" style={{ '--hero-rise-delay': '320ms' }}>
          {chips.map((label) => (
