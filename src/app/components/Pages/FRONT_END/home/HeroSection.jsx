...
const HeroSection = () => {
  return (
    <section className="weelp-hero-rise relative mb-12 md:mb-16 lg:mb-24 w-full overflow-hidden bg-surface-tint">
      <Image src="/assets/images/home-hero-bg-new.png" alt="" fill priority sizes="100vw" className="object-cover object-[60%_50%] -z-10" />

      <div className="container-page relative z-0 flex flex-col items-start gap-5 pt-[156px] pb-10 sm:pt-[170px] md:gap-6 md:pt-[180px] md:pb-20 lg:pt-[214px] lg:pb-32">
        <span
