  ...
  return (
    ...
    >
      <div className="container-page relative z-0 flex flex-col items-center justify-center text-center">
        ...
        <h1
          className="hero-rise mb-3 text-[28px] sm:text-[38px] md:text-[48px] leading-[1.05] text-[#18181b]"
          style={{ '--hero-rise-delay': '80ms' }}
        >
          Find your next escape
        </h1>
        <p
          className="hero-rise mb-8 max-w-[44ch] text-base sm:text-lg font-medium leading-[1.4] text-[#52525b]"
          style={{ '--hero-rise-delay': '160ms' }}
        >
        ...
        <div
          className="hero-rise mt-6 flex flex-wrap items-center justify-center gap-3"
          style={{ '--hero-rise-delay': '320ms' }}
        >
          {chips.map((label) => (
            <span
              key={label}
              className="inline-flex items-center gap-2 rounded-full border border-[#e4e4e7] bg-white/90 px-4 py-2 text-xs font-semibold text-[#18181b]"
            >
