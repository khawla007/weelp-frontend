...
const PRIMARY_HEADING = 'Find your next';
    ...
    <section data-home-hero data-home-hero-motion="pending" className="relative isolate mb-10 w-full overflow-hidden bg-surface-tint sm:mb-16 md:h-[100svh] lg:mb-24">
      ...
      <div className="container-page relative z-0 flex flex-col items-start gap-5 pb-10 pt-[135px] sm:pb-16 sm:pt-[170px] md:h-full md:gap-6 md:pb-20 md:pt-[180px] lg:pb-32 lg:pt-[214px]">
        <span
          ...
          style={HERO_OBJECT_MOTION_IMMEDIATE}
        >
        ...
        >
          <HeroBlurLine text={PRIMARY_HEADING} className="block font-medium" />
        </h1>
        ...
        <p
          ...
          style={{ ...HERO_OBJECT_MOTION_DELAYED, '--weelp-hero-subtitle-shade': 'rgba(0, 0, 0, 0.35)' }}
        >
          <span className="weelp-rise-mask weelp-rise-mask--block">Beach stays, marina views, and easy city plans in one place.</span>
        </p>

        <div className="weelp-hero-ui-rise relative z-20 w-full max-w-[920px]" style={{ ...HERO_OBJECT_MOTION_IMMEDIATE, marginTop: '-6px' }}>
          <HeroSearchPill />
        </div>
        ...
        <ul
          ...
          style={HERO_OBJECT_MOTION_DELAYED}
        >
