...
const WanderersBanner = () => {
  return (
    <section aria-labelledby="wanderers-heading" className="relative w-full overflow-hidden bg-white mb-10 md:mb-16 lg:mb-24">
      <svg aria-hidden="true" viewBox="0 0 275 572" preserveAspectRatio="xMinYMid meet" className="pointer-events-none absolute bottom-[111px] left-0 hidden h-[260px] w-auto translate-y-1/2 md:block">
      ...
      <svg
        ...
        className="pointer-events-none absolute bottom-[111px] right-0 hidden h-[260px] w-auto md:block"
