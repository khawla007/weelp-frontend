...
export default function ToursHero() {
  return (
    <Reveal as="section" scale duration={700} className="relative z-50 min-h-[320px] sm:min-h-[420px] flex justify-center items-center bg-[#f8faf9] p-6 mb-10 md:mb-16 lg:mb-24">
