    ...
    <div className="flex justify-between py-8 flex-wrap gap-4">
      ...
      <div className="relative">
        <div className="flex gap-4 flex-wrap">
          <button className="flex items-center gap-4 text-weelp-steel border text-base p-2 px-6  rounded-lg" onClick={(e) => e.preventDefault()}>
            View on map
            <Map size={18} />
          </button>
          <button className="flex items-center gap-4 text-weelp-steel border text-base p-2 px-6  rounded-lg" onClick={handleSort}>
