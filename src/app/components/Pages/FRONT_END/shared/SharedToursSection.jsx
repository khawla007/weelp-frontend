      ...
      <div className="flex flex-wrap items-center gap-3 md:gap-4">
        ...
        <div className="flex w-full shrink-0 items-center gap-2 md:ml-auto md:w-auto md:gap-3">
          ...
          <div className="relative" ref={sortRef}>
            ...
            {showSortDropdown && (
              <div className="absolute left-0 top-full z-10 mt-1 min-w-[200px] rounded-lg border border-border bg-background py-1 shadow-lg dark:shadow-none md:left-auto md:right-0">
