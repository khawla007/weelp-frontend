...
const AboutHero = () => (
  <section className="weelp-hero-rise relative mb-10 flex h-[420px] items-center overflow-hidden md:mb-16 md:h-[520px] lg:mb-24">
    <Image src="/assets/images/hero_bg_1.jpg" alt="" fill priority sizes="100vw" className="object-cover" />
    ...
    <div className="container-page relative">
      <div className="mb-4 inline-flex items-center gap-1.5 rounded-full bg-weelp-sage-tint/50 px-4 py-1.5 text-xs font-semibold text-weelp-sage-text">
        <span>Home</span>
