      ...
      <Reveal initialHidden stagger={60} variant="lift" className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {cards.map((card, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-background rounded-[24px] p-8 border border-border transition-shadow duration-300 hover:shadow-[0_1px_2px_rgba(24,24,27,0.06),0_4px_12px_rgba(24,24,27,0.08)]"
            >
