...
const BannerSection = () => {
  return (
    <section className="weelp-hero-rise relative z-50 mb-10 min-h-[320px] sm:mb-16 sm:min-h-[420px] lg:mb-24 h-full flex justify-center items-center bg-surface-tint p-6">
