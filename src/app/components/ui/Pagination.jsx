  ...
  return (
    <div className={`flex gap-1 md:gap-2 justify-center md:justify-end flex-wrap ${align === 'center' ? 'justify-center' : ''}`}>
      <button
        ...
        className="flex size-11 items-center justify-center rounded-[7.68px] border bg-background text-copy shadow-[0_1.89px_4.13px_rgba(60,66,87,0.08)] transition-[color,background-color,border-color,box-shadow,opacity] duration-200 motion-reduce:transition-none disabled:opacity-45"
      ...
      {pages.map((page, index) =>
        page === '...' ? (
          <span key={`ellipsis-${index}`} className="flex size-11 items-center justify-center text-weelp-steel" style={BTN_STYLE}>
            ...
          </span>
        ) : (
          <button
            ...
            className={`flex size-11 items-center justify-center rounded-[7.68px] border transition-[color,background-color,border-color,box-shadow,opacity] duration-200 motion-reduce:transition-none ${
