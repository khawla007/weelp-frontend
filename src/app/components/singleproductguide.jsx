...
export const BlogCard = ({ imageSrc = '', blogTitle = '', created_at = '', slug = '' }) => {
  return (
    <div className="max-w-full sm:max-w-sm w-full flex flex-col bg-white rounded-xl overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.1)] hover:shadow-[0_0_30px_rgba(0,0,0,0.18)] transition-shadow duration-300 ease-[var(--weelp-ease-out)] motion-reduce:transition-none border border-gray-50 mb-4">
