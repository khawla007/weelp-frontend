...
export const DASHBOARD_PLACEHOLDER_IMAGE =
 ...
 */
export function CardImage({ src, alt = 'item image', className = 'w-full h-40 object-cover', fallback = DASHBOARD_PLACEHOLDER_IMAGE }) {
  return (
    <img
      className={className}
      src={src || fallback}
