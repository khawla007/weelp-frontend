  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: 'day-range-start !bg-[#588f7a]/25 rounded-l-md [&>button]:!bg-[#588f7a] [&>button]:!text-white [&>button]:hover:!bg-[#588f7a] [&>button]:hover:!text-white',
        range_end: 'day-range-end !bg-[#588f7a]/25 rounded-r-md [&>button]:!bg-[#588f7a] [&>button]:!text-white [&>button]:hover:!bg-[#588f7a] [&>button]:hover:!text-white',
        range_middle: 'day-range-middle aria-selected:!bg-[#588f7a]/25 aria-selected:!text-gray-900',
        selected: cn(props.mode === 'range' ? 'day-selected' : '[&>button]:focus:bg-[#588f7a] [&>button]:focus:text-white'),
