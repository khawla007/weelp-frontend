...
const Card = React.forwardRef(({ className, ...props }, ref) => <div ref={ref} className={cn('rounded-lg border bg-card text-card-foreground shadow-sm dark:shadow-none', className)} {...props} />);
