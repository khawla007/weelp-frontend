...
const Checkbox = React.forwardRef(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    {...props}
  >
    <CheckboxPrimitive.Indicator className={cn('flex items-center justify-center text-current transition-none [&_svg]:transition-none [&_svg]:transform-none [&_svg]:scale-100')}>
