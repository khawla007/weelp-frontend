  ...
  theme: {
    extend: {
      colors: {
        ...
        weelp: {
          'sage-deep': 'rgb(var(--weelp-sage-deep-rgb) / <alpha-value>)',
          'sage-hover': 'rgb(var(--weelp-sage-hover-rgb) / <alpha-value>)',
          'sage-tint': 'rgb(var(--weelp-sage-tint-rgb) / <alpha-value>)',
          'sage-wash': 'hsl(var(--weelp-sage-wash))',
          steel: 'rgb(var(--weelp-steel-rgb) / <alpha-value>)',
          copy: 'rgb(var(--copy-rgb) / <alpha-value>)',
          label: 'rgb(var(--label-rgb) / <alpha-value>)',
          ink: 'rgb(var(--ink-rgb) / <alpha-value>)',
          discount: 'rgb(var(--weelp-discount-rgb) / <alpha-value>)',
        },
      },
      keyframes: {
        'accordion-down': {
